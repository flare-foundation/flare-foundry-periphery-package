...
contract FlareContractRegistryMock is IFlareContractRegistry {
    ...
    string[] public correctContractNames = [
        ...
        ("FlareAssetRegistry"), ("ValidatorRegistry"), ("DistributionTreasury"), ("PriceSubmitter"), ("Supply"), ("FtsoRewardManager"), ("DistributionToDelegators"), ("AddressUpdater"), ("PollingFtso"), ("InitialAirdrop"), ("WNat"), ("ValidatorRewardManager"), ("GovernanceVotePower"), ("ClaimSetupManager"), ("StateConnector"), ("PollingFoundation"), ("CleanupBlockNumberManager"), ("Inflation"), ("PChainStakeMirrorVerifier"), ("InflationAllocation"), ("FtsoManager"), ("PChainStakeMirror"), ("FlareDaemon"), ("AddressBinder"), ("CombinedNat"), ("GovernanceSettings"), ("IncentivePoolTreasury"), ("FtsoRegistry"), ("Escrow"), ("FlareContractRegistry"), ("PChainStakeMirrorMultiSigVoting"), ("VoterWhitelister"), ("IncentivePool"), ("IncentivePoolAllocation") 

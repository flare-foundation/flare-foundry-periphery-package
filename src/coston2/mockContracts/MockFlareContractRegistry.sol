...
contract FlareContractRegistryMock is IFlareContractRegistry {
    ...
    string[] public correctContractNames = [
        ...
        ("WNat"), ("FlareAssetRegistry"), ("FtsoRegistry"), ("PChainStakeMirrorVerifier"), ("IncentivePoolAllocation"), ("FlareDaemon"), ("InitialAirdrop"), ("GovernanceSettings"), ("FtsoRewardManager"), ("PChainStakeMirrorMultiSigVoting"), ("IncentivePool"), ("DistributionTreasury"), ("AddressUpdater"), ("IncentivePoolTreasury"), ("Supply"), ("GovernanceVotePower"), ("InflationAllocation"), ("Inflation"), ("DistributionToDelegators"), ("PChainStakeMirror"), ("FlareContractRegistry"), ("CleanupBlockNumberManager"), ("FtsoManager"), ("CombinedNat"), ("PollingFtso"), ("PollingFoundation"), ("ValidatorRewardManager"), ("StateConnector"), ("AddressBinder"), ("VoterWhitelister"), ("PriceSubmitter"), ("ValidatorRegistry"), ("ClaimSetupManager"), ("Escrow") 

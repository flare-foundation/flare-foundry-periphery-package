...
contract FlareContractRegistryMock is IFlareContractRegistry {
    ...
    string[] public correctContractNames = [
        ...
        ("FlareDaemon"), ("InitialAirdrop"), ("FtsoRewardManager"), ("Inflation"), ("FtsoManager"), ("IncentivePool"), ("ClaimSetupManager"), ("FlareAssetRegistry"), ("VoterWhitelister"), ("StateConnector"), ("PollingFtso"), ("DistributionTreasury"), ("WNat"), ("PollingFoundation"), ("DistributionToDelegators"), ("FlareContractRegistry"), ("IncentivePoolTreasury"), ("PChainStakeMirrorMultiSigVoting"), ("CleanupBlockNumberManager"), ("FtsoRegistry"), ("PChainStakeMirror"), ("CombinedNat"), ("PChainStakeMirrorVerifier"), ("GovernanceVotePower"), ("ValidatorRegistry"), ("InflationAllocation"), ("GovernanceSettings"), ("ValidatorRewardManager"), ("Supply"), ("AddressBinder"), ("PriceSubmitter"), ("Escrow"), ("AddressUpdater"), ("IncentivePoolAllocation") 
